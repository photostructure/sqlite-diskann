...
static int insert_test_row(sqlite3 *db, const char *table, int64_t id, const uint8_t *data, size_t size) {
    char *sql = sqlite3_mprintf("INSERT INTO %s_shadow (id, data) VALUES (?, ?)", table);
